...
const quizInfo = {
  databricksDataEngineer: {
    ...
    desc: "Databricks SQL、Delta Lake、ETL、Lakehouse、ジョブ、権限管理、パフォーマンス最適化"
  },
  databricksML: {
    title: "Databricks Certified Machine Learning Associate",
    desc: "MLflow、特徴量、AutoML、モデル管理、Spark ML、評価指標、MLOps"
  },
  snowproCore: {
    title: "Snowflake SnowPro Core",
    desc: "Snowflake基礎、ウェアハウス、ストレージ、SQL、権限、データロード、共有"
  },
  snowproArchitect: {
    title: "Snowflake SnowPro Advanced Architect",
    desc: "Snowflake設計、マルチアカウント、セキュリティ、性能、DR、コスト最適化"
  },
  huggingFaceAgents: {
    title: "Hugging Face AI Agents Course Certificate",
    desc: "Transformer、Tools、Agents、RAG、Spaces、Inference、評価、安全性"
  },
  openAIAcademy: {
    title: "OpenAI Academy Certificate",
    desc: "生成AI基礎、プロンプト、API、RAG、エージェント、安全性、業務活用"
  }
};
...
if (type === "all") {
  document.title = "Databricks・Snowflake・AI資格クイズ";
  pageTitle.textContent = "Databricks・Snowflake・AI資格クイズ";
  pageDesc.textContent = "6カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.databricksDataEngineer;
